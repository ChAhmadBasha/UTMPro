...
# Build this FIRST before any C# code
...
CREATE TABLE UserTokens (
    ...
    -- Values: 'EmailVerify' | 'PasswordReset'
...
CREATE TABLE Plans (
    ...
    -- Values: 'Free' | 'Pro' | 'Business' | 'Advanced'
...
CREATE TABLE Domains (
    ...
    DNSType            NVARCHAR(10)   NOT NULL DEFAULT 'A',
    DNSValue           NVARCHAR(255)  NOT NULL DEFAULT '76.76.21.21',
...
-- ============================================================
-- TABLE 12: LinkDestinations (Weighted URLs - ADDON 1 & 2)
-- CRITICAL TABLE - Powers weighted redirect
-- ============================================================
CREATE TABLE LinkDestinations (
    ...
    -- FALSE = user URL | TRUE = admin injected URL
    IsActive    BIT            NOT NULL DEFAULT 1,
...
CREATE TABLE LinkTargetingRules (
    ...
    -- Values: 'Geo' | 'iOS' | 'Android' | 'Device'
    RuleValue   NVARCHAR(500)  NOT NULL,
    -- Geo: 'US' | iOS: App Store URL | Android: Play URL
...
-- ============================================================
-- TABLE 14: AdminTrafficRules (ADDON 1)
-- ============================================================
CREATE TABLE AdminTrafficRules (
    Id              BIGINT IDENTITY(1,1) PRIMARY KEY,
    WorkspaceId     BIGINT        NULL REFERENCES Workspaces(Id),
    -- NULL = Global rule (applies to ALL workspaces)
...
-- ============================================================
-- TABLE 15: AdminTrafficUrls (ADDON 1)
-- ============================================================
...
-- ============================================================
-- TABLE 16: ClickEvents (HIGH VOLUME - Batch Insert Target)
-- ============================================================
...
CREATE TABLE WorkspaceBillingHistory (
    ...
    -- Values: 'Assigned'|'Upgraded'|'Downgraded'|'Cancelled'
